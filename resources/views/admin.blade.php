            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <!-- added this right here to logout the user... @wcr -->
                ...
                <section class="col-lg-7 connectedSortable">
                    ...
                    <div class="box box-primary">
                        ...
                        <i class="fa fa-ellipsis-v"></i>
                                    ...
                                    <!-- todo text -->
                                    <span class="text">Prepare payrolls</span>
                                    <!-- Emphasis label -->
                      ...
                      <span class="handle">
                        ...
                        <i class="fa fa-ellipsis-v"></i>
                                    ...
                                    <input type="checkbox" value="">
                                    <span class="text">Recruit staffs</span>
                      ...
                      <span class="handle">
                        ...
                        <i class="fa fa-ellipsis-v"></i>
                                    ...
                                    <input type="checkbox" value="">
                                    <span class="text">Weekly sprint review</span>
...
<!-- Bootstrap 3.3.7 -->
<script src="{{ asset('bower_components/admin-lte/bootstrap/dist/js/bootstrap.min.js') }}"></script>
<!-- Morris.js charts -->
